...
a.data("lastclick-timeout",!1)};(function(a){var e=this;c.call(e);var f=b(e);f.data("lastclick-clicks",(f.data("lastclick-clicks")||0)+1);var g=setTimeout(function(){var h=f.data("lastclick-clicks");c.apply(e,[a]);f.data("lastclick-clicks",0);a.type="lastclick";b.event.handle.apply(e,[a,h])},300);f.data("lastclick-timeout",g)}).apply(this,[a])}};b.fn.preventDefault=b.fn.preventDefault||function(){return b(this).click(function(a){a.preventDefault();return!1})};b.LightboxClass=function(){this.construct()};
b.fn.lightbox=function(a){b.Lightbox=b.Lightbox||new b.LightboxClass;if(b.Lightbox.ie6&&!b.Lightbox.ie6_support)return this;var a=b.extend({start:!1,events:!0},a),c=b(this);a.events&&(c.preventDefault().once("lastclick",function(a){var e=b(this),e=c.index(e);if(!b.Lightbox.init(e,c))return!1;if(!b.Lightbox.start())return!1;a.preventDefault();return!1}),c.addClass("lightbox-enabled"));if(a.start){b(this);if(!b.Lightbox.init(0,c))return this;b.Lightbox.start()}return this};b.extend(b.LightboxClass.prototype,
{images:[],constructed:!1,compressed:null,src:null,baseurl:null,files:{compressed:{scripts:{lightbox:"scripts/jquery.lightbox.min.js",colorBlend:"scripts/jquery.color.min.js"},styles:{lightbox:"styles/jquery.lightbox.min.css"}},uncompressed:{scripts:{lightbox:"scripts/jquery.lightbox.js",colorBlend:"scripts/jquery.color.js"},styles:{lightbox:"styles/jquery.lightbox.css"}},images:{prev:"images/prev.gif",next:"images/next.gif",blank:"images/blank.gif",loading:"images/loading.gif"}},text:{image:"Image",
of:"of",close:"Close X",closeInfo:"You can also click anywhere outside the image to close.",download:"Download.",help:{close:"Click to close",interact:"Hover to interact"},about:{text:"jQuery Lightbox Plugin (balupton edition)",title:"Licenced under the GNU Affero General Public License.",link:"http://www.balupton.com/projects/jquery-lightbox"}},keys:{close:"c",prev:"p",next:"n"},handlers:{show:null},opacity:0.9,padding:null,speed:400,rel:"lightbox",auto_relify:!0,auto_scroll:"follow",auto_resize:!0,
ie6:null,ie6_support:!0,colorBlend:null,download_link:!0,show_helper_text:!0,show_linkback:!0,show_info:"auto",show_extended_info:"auto",options:["show_helper_text","auto_scroll","auto_resize","download_link","show_info","show_extended_info","ie6_support","colorBlend","baseurl","files","text","show_linkback","keys","opacity","padding","speed","rel","auto_relify"],construct:function(a){var c=typeof this.constructed==="undefined"||this.constructed===!1;this.constructed=!0;var d=c,a=a||{},e=function(a,
b){if(typeof a==="object")for(var c in a)a[c]=e(a[c],b);else if(typeof b==="array"){c=0;for(var d=a.length;c<d;++c)a[c]=e(a[c],b)}else a=b+a;return a};if(c&&typeof a.files==="undefined"){this.compressed=null;var f=b('script[src*="'+this.files.compressed.scripts.lightbox+'"]:first');if(f.length!==0)b.extend(!0,this.files,this.files.compressed),this.compressed=!0;else if(f=b('script[src*="'+this.files.uncompressed.scripts.lightbox+'"]:first'),f.length!==0)b.extend(!0,this.files,this.files.uncompressed),
